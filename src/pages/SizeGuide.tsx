...
const categories = [
  ...
  },
  {
    ...
    measurements: [
      { size: "S", Width: "102", length: "69", shoulder: "44", sleeve: "62" },
      { size: "M", Width: "106", length: "71", shoulder: "46", sleeve: "64" },
      { size: "L", Width: "110", length: "73", shoulder: "48", sleeve: "66" },
      { size: "XL", Width: "116", length: "75", shoulder: "50", sleeve: "68" },
      { size: "XXL", Width: "122", length: "77", shoulder: "52", sleeve: "70" }
    ]
  },
  {
    name: "Wind Breaker",
    image: "/WIND BREAKER.png",
    description: "Our jackets are true to size with a contemporary cut. For a looser fit, we recommend going up one size.",
    measurements: [
      { size: "S", Width: "108", length: "71", shoulder: "46", sleeve: "64" },
      { size: "M", Width: "112", length: "73", shoulder: "48", sleeve: "65" },
      { size: "L", Width: "116", length: "75", shoulder: "50", sleeve: "66" },
      { size: "XL", Width: "122", length: "77", shoulder: "52", sleeve: "67" },
      { size: "XXL", Width: "128", length: "79", shoulder: "54", sleeve: "68" }
    ]
  },
  {
    name: "Sweat Pants",
    ...
    measurements: [
      { size: "S", waist: "72-76", hip: "98", length: "102", inseam: "74" },
      { size: "M", waist: "76-80", hip: "102", length: "104", inseam: "75" },
      { size: "L", waist: "80-84", hip: "106", length: "106", inseam: "76" },
      { size: "XL", waist: "84-88", hip: "110", length: "108", inseam: "77" },
      { size: "XXL", waist: "88-92", hip: "114", length: "110", inseam: "78" }
    ]
  }
];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <motion.div
        ...
        className="max-w-6xl mx-auto pt-24 px-4 sm:px-6 lg:px-8 pb-16"
      >
        <motion.div 
        ...
        >
          <h1 className="text-5xl font-light mb-3 text-gray-800">SIZE GUIDE</h1>
        ...
        <Tabs defaultValue={categories[0].name} className="space-y-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                ...
                >
                  <div className="aspect-square relative overflow-hidden bg-gray-100">
                    <img
                      src={category.image}
                      alt={`${category.name} Size Guide`}
                      className="absolute inset-0 w-full h-full object-contain p-4"
                    />
                  </div>
                  
                  <div className="p-6">
                    <h3 className="text-xl font-medium text-gray-900 mb-2">How to Measure</h3>
                    <motion.button
                          ...
                          {Object.entries(measurementGuide)
                            .filter(([key]) => {
                              if (category.name === "Sweat Pants") {
                                return ["waist", "hip", "length", "inseam"].includes(key);
                              }
